...
const Nav = () => {
  ...
  return (
    <div className="w-full border-b py-2 fixed z-10 top-0 bg-white">
        ...
        <div className="relative flex items-center justify-between h-16">
          ...
          <div className="pr-2 sm:static sm:inset-auto sm:pr-0 hidden sm:block">
            <div className="mx-5">
              ...
              {aboutDropdownOpen && (
                <div
                  class="origin-top-right absolute top-50 mt-2 shadow-lg py-1 bg-white ring-black ring-opacity-5 focus:outline-none font-bold"
                  tabindex="-1"
      ...
      <div
        className={`z-50 m-0 h-screen w-full absolute right-0 bg-gray-50 ${
